...
using namespace std;
 ...
 int main(int argc, char* argv[])
 {
  ...
  while((ch = getopt_long(argc, argv, "c:r:o:m:n:d:k:e:a:s:t:f:q:b:h", long_options, NULL)) != -1) {
	...
	//Si salva tutte le reads nelle strutture (readSet)
	...
	//inizializza una struttura dati utilizzando informazioni da un file di k-mer binari, un insieme di read e altre informazioni
	...
	//subReadCount specifica il numero di sottoinsiemi di read da considerare.
	// Alloca lo spazio per la kmerRreadNodeHead
